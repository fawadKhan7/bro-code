export const CONDUCTOR_TOOL_SCHEMAS = [
  {
    name: "get_contract",
    description:
      "Returns contract updates from the other agent since sinceVersion. Use before starting work that depends on peer output.",
    inputSchema: {
      type: "object",
      properties: {
        agent_id: {
