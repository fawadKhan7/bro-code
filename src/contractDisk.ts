...
/** Duplicated here to avoid circular imports with mcpServer. */
export type ContractAgentId = "A" | "B";
...
export function writeContractRevisionToDisk(
  ...
  const block =
    `<!-- duo-agent contract revision — safe to commit after redacting secrets -->\n` +
